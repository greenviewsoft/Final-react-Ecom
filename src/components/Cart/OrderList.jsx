...
PostReview = () => {
  ...
  cogoToast.error("Comment  Cannot Be More than 150",{position:'top-right'});
  }
  else {
    ...
    MyFromData.append('reviewer_commnents', comment)
...
<Col md={6} lg={6} sm={6} xs={6}>
          ...
          <h6>Order status = {ProductList.order_status}</h6>
          <h6>Product Code = {ProductList.product_code }</h6>
        </Col>
